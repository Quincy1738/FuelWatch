...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    super.initState();
    _startAutoReduction(); // Start reduction when screen loads
  }
  ...
  @override
  void dispose() {
    _reductionTimer?.cancel(); // Clean up timer
    super.dispose();
  }
    ...
    return Scaffold(
      body: IndexedStack(
        ...
        children: [
          ...
          AnalyticsPage(totalRevenue: totalRevenue),
        ],
      ),
          ...
          _dieselPriceController,
            ...
            if (dieselLiters + inputLiters > maxDieselCapacity) {
              ...
              setState(() {
                ...
                double revenue = inputLiters * inputPrice;
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              trailing: Text("₱${totalRevenue.toStringAsFixed(2)}", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blue)),
            ),
          ],
        ),
      ),
  ...
  Widget _buildAlertSection() {
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 8),
        if (alerts.isNotEmpty) ...alerts else _buildAlertTile("No Alerts", "Fuel levels are normal", Icons.check_circle_outline),
      ],
    );
  }
